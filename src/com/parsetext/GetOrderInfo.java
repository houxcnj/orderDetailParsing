...
public class GetOrderInfo {
    ...
    public static void main(String[] args) {
        ...
        String sellerId = "ANK8P1OMW3VD1";
        request.setSellerId(sellerId);
        String mwsAuthToken = "";
        request.setMWSAuthToken(mwsAuthToken);
        List<String> amazonOrderId = new ArrayList<String>();
        String amazonOrderId1 = "113-9320032-2769861";
        amazonOrderId.add(amazonOrderId1);
        ...
        try {
        	 ...
        	 String res1 = doc.getElementsByTagName("AddressLine2").item(0).getTextContent();
